...
export const DashboardView: React.FC<DashboardViewProps> = ({ onNavigate, isAdmin }) => {
  ...
  return (
    <div className="space-y-5 pb-8">
      {/* High Density Section: 4 Main Shortcuts (Req 3: แสดงเป็นภาษาไทย สวยงาม และดูเป็นมืออาชีพ) */}
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4 shrink-0">
        {/* Card 1: น้ำหนักและส่วนสูง */}
        <div
          onClick={() => onNavigate('weight-height')}
          className="group relative bg-white border border-slate-200/90 hover:border-emerald-500/50 p-4 sm:p-4.5 rounded-2xl shadow-2xs hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-radial from-emerald-100/40 to-transparent rounded-bl-full pointer-events-none" />
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-full border border-emerald-200/70">
                ระบบที่ 1
              </span>
            </div>
            ...
            <p className="text-xs text-slate-500 mt-1 line-clamp-1">บันทึก & วิเคราะห์ภาวะโภชนาการ BMI</p>
          </div>
          <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs">
            <span className="font-semibold text-slate-600 bg-slate-50 px-2 py-0.5 rounded-md">
              {weightRecordsCount} บันทึกตรวจวัด
            </span>
        ...
        {/* Card 2: ข้อมูลประวัตินักเรียน */}
        <div
          onClick={() => onNavigate('students')}
          className="group relative bg-white border border-slate-200/90 hover:border-blue-500/50 p-4 sm:p-4.5 rounded-2xl shadow-2xs hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-radial from-blue-100/40 to-transparent rounded-bl-full pointer-events-none" />
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-bold text-blue-700 bg-blue-50 px-2.5 py-0.5 rounded-full border border-blue-200/70">
                ระบบที่ 2
              </span>
            </div>
            ...
            <p className="text-xs text-slate-500 mt-1 line-clamp-1">ทะเบียนประวัติและคัดกรองรายบุคคล</p>
          </div>
          <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs">
            <span className="font-semibold text-slate-600 bg-slate-50 px-2 py-0.5 rounded-md">
              {totalStudents} คนในห้องเรียน
            </span>
        ...
        {/* Card 3: เงินฝาก & เช็คชื่อ */}
        <div
          onClick={() => onNavigate('bank-attendance')}
          className="group relative bg-white border border-slate-200/90 hover:border-amber-500/50 p-4 sm:p-4.5 rounded-2xl shadow-2xs hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-radial from-amber-100/40 to-transparent rounded-bl-full pointer-events-none" />
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-bold text-amber-800 bg-amber-50 px-2.5 py-0.5 rounded-full border border-amber-200/70">
                ระบบที่ 3
              </span>
            </div>
            ...
            <p className="text-xs text-slate-500 mt-1 line-clamp-1">ธนาคารโรงเรียนและเช็คชื่อประจำวัน</p>
          </div>
          <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs">
        ...
        {/* Card 4: กรอกคะแนน & ตัดเกรด */}
        <div
          onClick={() => onNavigate('scores')}
          className="group relative bg-white border border-slate-200/90 hover:border-purple-500/50 p-4 sm:p-4.5 rounded-2xl shadow-2xs hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col justify-between overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-radial from-purple-100/40 to-transparent rounded-bl-full pointer-events-none" />
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-bold text-purple-700 bg-purple-50 px-2.5 py-0.5 rounded-full border border-purple-200/70">
                ระบบที่ 4
              </span>
            </div>
            <h3 className="font-bold text-slate-800 text-base group-hover:text-purple-700 transition-colors">
              กรอกคะแนน & ตัดเกรด
            </h3>
            <p className="text-xs text-slate-500 mt-1 line-clamp-1">จัดการคะแนนรายบทและตัดเกรดอัตโนมัติ</p>
          </div>
          <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs">
            <span className="font-semibold text-slate-600 bg-slate-50 px-2 py-0.5 rounded-md">
              {scoreSheetsCount} รายวิชา
            </span>
